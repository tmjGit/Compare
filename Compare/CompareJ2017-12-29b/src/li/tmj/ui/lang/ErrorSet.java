...
public final class ErrorSet {//implements ComboBoxable { 			
	...
	public static String couldnotgetWindowspathLOCALAPPDATAforthelogfile() { return "Could not get Windows' path %LOCALAPPDATA% for the log file.";}//get("CouldnotgetWindowspathLOCALAPPDATAforthelogfile"); }
