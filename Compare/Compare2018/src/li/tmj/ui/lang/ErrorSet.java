...
public final class ErrorSet {//implements ComboBoxable { 			
	...
	public static String criterionCountNotSet() { return "FSItem.criterionCount was not set!";}//get(""); }
	...
	public static String matchesArrayMustContainAnElementForEachCriterion() { return "The matches array must contain an element for each criterion, that is %s this time!";}//get(""); }
