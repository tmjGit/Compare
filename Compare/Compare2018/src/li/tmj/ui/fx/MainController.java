...
//	@FXML ObjectCombobox<Language> langCb;
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		FSItem.setCriterionCount( Integer.parseInt( Application.confMainGet("rowcount") )-1 );
		Rows.createRows(fsco,
				FSItem.getCriterionCount()+1, //adjustable preset 
				new Pane[] {anchorPane1,anchorPane2,anchorPane3,anchorPane1});
	}

	private void setFxText() {
//		detailsBt.setText("Detail");//Localization.get("Detail"));
...
//				default: undefined error exception
	...
	@FXML public void addBtAction(ActionEvent event) {
		FSItem.setCriterionCount( FSItem.getCriterionCount()+1 );
		Rows.addRow();
	}
...
//TODO		ComboBox<Language> cb=(ComboBox<Language>) event.getSource();
	...
	@FXML public void detailsBtAction(javafx.event.ActionEvent event)  {
		try {
			FxScene.DETAIL.showOnNewStage();
		} catch (IOException e) {
